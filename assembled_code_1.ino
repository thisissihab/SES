  ...
  if (status != MFRC522::STATUS_OK) {
   ...
   int i=0;
    ...
    if(found){
      ...
      Serial.print("Not Card Detected%");
      Serial.print("Do you want to register this ID?$");
...
void write_to_memory(){
  ...
  delay(2000);
  employee_reg[number_of_employees] = id;
  Serial.println(employee_reg[number_of_employees]);
